...
INSERT IGNORE INTO user (username, password, email, phone, country) VALUES
('alice', '$2a$10$7d3F1XSlm2b5v5MxJQhF7uS9Gv8OuZa6XK/wKwMvqHdOQfJr5JZle', 'alice@example.com', '1234567890', 'China'),
('bob', '$2a$10$VfHh3fWQk9kIQrTg/sS4D.vLMFqMyNq7LYjcWVKaeo0If92rfOJrC', 'bob@example.com', '0987654321', 'USA');
...
-- 插入乘客数据
--INSERT IGNORE INTO passenger (name, booking_id, id_number) VALUES
